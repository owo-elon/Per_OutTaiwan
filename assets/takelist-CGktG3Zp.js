import{L as qe,c as I}from"./index-BHD_QJgL.js";import{c as Ge,P as Je,i as Ve,d as Ue,r as l,w as S,o as Ke,a as Qe,b,e as Ze}from"./vue-vendor-CPMyeukm.js";import"./three-DQbwDAWq.js";import"./vendor-Bsgzf06I.js";const et=Ue({name:"TakeList",components:{LayoutComponent:qe},setup(){const p=l(1),c=l(""),m=l(""),x=l(""),U=l("All"),L=l({}),Y=l(!0),K=l(!1),D=l(!1),he=l(!1),z=l(!1),Q=l(!1),E=l(!1),Z=l(!1),O=l(""),A=l("🚨 非常重要"),i=Ze([]),h=l([]),f=l(0),d=l(0),r=l(!1),g=l(!1),N=l(0);let F=0;const w=l(0),j=l(0),fe=l(null),v=l(0),ke=()=>{v.value>0?v.value--:v.value=u.value.length-1},pe=()=>{v.value<u.value.length-1?v.value++:v.value=0},ge=l(localStorage.getItem("darkMode")==="true"),P=l({countries:{},global:{show:!1,message:""}}),we=b(()=>!c.value||!P.value.countries?null:P.value.countries[c.value]||null),ee={korea:{name:"韓國",flag:"🇰🇷",implemented:!0},japan:{name:"日本",flag:"🇯🇵",implemented:!1},thailand:{name:"泰國",flag:"🇹🇭",implemented:!1},usa:{name:"美國",flag:"🇺🇸",implemented:!1},europe:{name:"歐洲",flag:"🇪🇺",implemented:!1}},T={must:[{id:"m1",name:"護照",checked:!1},{id:"m2",name:"手機",checked:!1},{id:"m3",name:"錢包",checked:!1},{id:"m4",name:"信用卡",checked:!1},{id:"m5",name:"網路卡/ESIM",checked:!1},{id:"m6",name:"錢(台幣/外幣)",checked:!1}],categories:[{name:"其他重要物品",icon:"💼",items:[{id:"i1",name:"登機證(可以申請記得先申請)",checked:!1},{id:"i2",name:"證件(身分證 健保卡)",checked:!1},{id:"i3",name:"行動電源",checked:!1},{id:"i4",name:"雨傘",checked:!1},{id:"i5",name:"萬國轉接頭",checked:!1},{id:"i6",name:"充電頭2顆",checked:!1},{id:"i7",name:"充電線2條(記得拿一條跟行動電源放一起)",checked:!1}]},{name:"包包",icon:"🎒",items:[{id:"b1",name:"後背包",checked:!1},{id:"b2",name:"側背包",checked:!1},{id:"b3",name:"收納腰包",checked:!1},{id:"b4",name:"行李替大~包 (掛行李箱上那個)",checked:!1},{id:"b5",name:"壓縮袋",checked:!1}]},{name:"衣物",icon:"👕",items:[{id:"c1",name:"衣服(記得帶睡衣) [幾夜]",checked:!1},{id:"c2",name:"褲子(記得帶睡褲) [幾夜]",checked:!1},{id:"c3",name:"內褲 [幾天]",checked:!1},{id:"c4",name:"內衣 [幾天]",checked:!1},{id:"c5",name:"襪子 [幾天]",checked:!1},{id:"c6",name:"拖鞋/涼鞋/布鞋",checked:!1},{id:"c7",name:"外套",checked:!1},{id:"c8",name:"帽子",checked:!1}]},{name:"盥洗用品",icon:"🧴",items:[{id:"t1",name:"牙刷牙膏",checked:!1},{id:"t2",name:"洗面乳",checked:!1},{id:"t3",name:"護髮乳",checked:!1},{id:"t4",name:"洗臉巾",checked:!1},{id:"t5",name:"隱形眼鏡+清洗液",checked:!1},{id:"t6",name:"髒衣袋",checked:!1},{id:"t7",name:"壓縮毛巾",checked:!1},{id:"t8",name:"牙籤",checked:!1},{id:"t9",name:"頸枕",checked:!1},{id:"t10",name:"眼罩",checked:!1},{id:"t11",name:"耳塞",checked:!1}]},{name:"文具用品/3C/備品",icon:"📱",items:[{id:"s1",name:"小剪刀(記得丟行李箱)",checked:!1},{id:"s2",name:"膠帶",checked:!1},{id:"s3",name:"筆",checked:!1},{id:"s4",name:"耳機",checked:!1},{id:"s5",name:"自拍棒",checked:!1},{id:"s6",name:"絕緣膠帶",checked:!1},{id:"s7",name:"飲料提袋",checked:!1},{id:"s8",name:"環保袋",checked:!1},{id:"s9",name:"衛生紙",checked:!1},{id:"s10",name:"濕紙巾",checked:!1},{id:"s11",name:"垃圾袋",checked:!1}]},{name:"藥品",icon:"💊",items:[{id:"p1",name:"小護士",checked:!1},{id:"p2",name:"防蚊液",checked:!1},{id:"p3",name:"木瓜霜",checked:!1},{id:"p4",name:"生理食鹽水",checked:!1},{id:"p5",name:"眼藥水",checked:!1},{id:"p6",name:"止痛藥",checked:!1},{id:"p7",name:"ok蹦",checked:!1},{id:"p8",name:"棉花棒",checked:!1}]},{name:"化妝品",icon:"💄",items:[{id:"mk1",name:"防曬",checked:!1},{id:"mk2",name:"粉底液+刀",checked:!1},{id:"mk3",name:"粉餅+海綿",checked:!1},{id:"mk4",name:"定妝液",checked:!1},{id:"mk5",name:"定妝粉",checked:!1},{id:"mk6",name:"腮紅",checked:!1},{id:"mk7",name:"眼影+刷具",checked:!1},{id:"mk8",name:"眉粉",checked:!1},{id:"mk9",name:"眼線筆",checked:!1},{id:"mk10",name:"睫毛膏+夾",checked:!1},{id:"mk11",name:"口紅",checked:!1},{id:"mk12",name:"卸妝水+巾",checked:!1},{id:"mk13",name:"梳子",checked:!1},{id:"mk14",name:"髮油",checked:!1},{id:"mk15",name:"香水",checked:!1},{id:"mk16",name:"髮圈",checked:!1},{id:"mk17",name:"鏡子",checked:!1}]},{name:"保養品",icon:"✨",items:[{id:"sk1",name:"化妝水",checked:!1},{id:"sk2",name:"蘆薈膠",checked:!1},{id:"sk3",name:"乳液",checked:!1}]}]},be=b(()=>{let e=i.filter(t=>t.isMust);return x.value&&(e=e.filter(t=>t.name.includes(x.value))),e}),u=b(()=>{const e=[],t=i.filter(a=>!a.isMust);return T.categories.forEach(a=>{let s=t.filter(n=>n.category===a.name);s.length>0&&e.push({name:a.name,icon:a.icon,items:s})}),e}),B=()=>{r.value?f.value=d.value:f.value+=(d.value-f.value)*.1,(Math.abs(d.value-f.value)>.001||r.value)&&requestAnimationFrame(B);const e=u.value.length;if(e>0){let t=Math.round(-f.value)%e;t<0&&(t+=e),v.value=t}},W=e=>{if(g.value)return;const t=u.value.length;if(t===0)return;let a=Math.round(-d.value)%t;a<0&&(a+=t);let s=e-a;s>t/2&&(s-=t),s<-t/2&&(s+=t),d.value-=s,requestAnimationFrame(B)};let y=!1,$=!1;const te=(e,t)=>{D.value=!1,H.value=!1,z.value=!1,g.value=!1,N.value=e,F=t,$=!0,y=!1,r.value=!1},xe=()=>{$=!1,y=!1},ye=e=>{console.log("onMouseDown triggered"),te(e.clientX,e.clientY)},ae=e=>{if(!$)return;const t=e.clientX,a=e.clientY;if(!r.value){const s=Math.abs(t-N.value),n=Math.abs(a-F);(s>5||n>5)&&(r.value=!0,w.value=t,j.value=0,requestAnimationFrame(B))}if(r.value){g.value=!0;const s=t-w.value;w.value=t,d.value+=s*.005,j.value=s*.005}},k=()=>{console.log("onMouseUp triggered"),xe(),r.value=!1,d.value=Math.round(d.value),f.value=d.value,setTimeout(()=>{g.value=!1},50)},Me=()=>{k()},Ce=e=>{te(e.touches[0].clientX,e.touches[0].clientY)},se=e=>{if(!$)return;const t=e.touches[0].clientX,a=e.touches[0].clientY;if(!r.value&&!y){const s=Math.abs(t-N.value),n=Math.abs(a-F);(s>5||n>5)&&(n>s?y=!0:(r.value=!0,w.value=t,j.value=0,requestAnimationFrame(B)))}if(!y&&(e.cancelable&&e.preventDefault(),r.value)){g.value=!0;const s=t-w.value;w.value=t,d.value+=s*.005,j.value=s*.005}};S(x,e=>{if(!e)return;const t=u.value.findIndex(a=>a.items.some(s=>s.name.toLowerCase().includes(e.toLowerCase())));t!==-1&&W(t)}),S(U,e=>{if(e==="All")return;const t=u.value.findIndex(a=>a.name===e);t!==-1&&W(t)});const le=new MutationObserver(e=>{e.forEach(t=>{t.attributeName==="class"&&(ge.value=document.body.classList.contains("dark"))})});Ke(()=>{He(),ze(),de(),le.observe(document.body,{attributes:!0}),window.addEventListener("mousemove",ae),document.addEventListener("mouseup",k),window.addEventListener("touchmove",se,{passive:!1}),window.addEventListener("touchend",k),window.addEventListener("touchcancel",k),window.addEventListener("click",re),window.addEventListener("scroll",ue,{passive:!0}),window.addEventListener("resize",X),X()}),Qe(()=>{le.disconnect(),window.removeEventListener("mousemove",ae),window.removeEventListener("mouseup",k),window.removeEventListener("touchmove",se),window.removeEventListener("touchend",k),window.removeEventListener("touchcancel",k),window.removeEventListener("click",re),window.removeEventListener("scroll",ue),window.removeEventListener("resize",X),document.documentElement.classList.remove("lock-all-scroll"),document.body.classList.remove("lock-all-scroll")}),S(x,e=>{if(!e)return;const t=u.value.findIndex(a=>a.items.some(s=>s.name.toLowerCase().includes(e.toLowerCase())));t!==-1&&W(t)});const Ie=e=>{const t=u.value.length;if(t===0)return{};let a=(e+f.value)%t;a<0&&(a+=t),a>t/2&&(a-=t);const s=Math.abs(a),o=window.innerWidth<768?85:110,Ne=Math.max(.7,1-s*.15),ve=Math.max(0,1-s*.6),Fe=a*-35,Re=s*-400;return{transform:`translateX(${a*(o*1.2)}%) translateZ(${Re}px) rotateY(${Fe}deg) scale(${Ne})`,opacity:ve,zIndex:Math.round(40-s*10),pointerEvents:s<2.5?"auto":"none",visibility:ve<.01?"hidden":"visible",filter:`blur(${s*2}px)`}},Se=e=>{L.value[e]=!L.value[e]},M=b(()=>i.length),R=b(()=>i.filter(e=>e.checked).length),Le=b(()=>M.value===0?0:Math.round(R.value/M.value*100)),De=(e,t)=>{if(I(t.clientX,t.clientY,"#10b981"),!ee[e].implemented){alert("此國家清單即將推出！目前請選擇韓國 🇰🇷");return}c.value=e,p.value=2,C()},Ee=(e,t)=>{I(t.clientX,t.clientY,"#10b981"),m.value=e,p.value=3,je(),C()},_=()=>`travel_packing_${c.value}_${m.value}`,ne=()=>`travel_packing_custom_${c.value}_${m.value}`,q=()=>`travel_packing_deleted_${c.value}_${m.value}`,ie=()=>{const e=i.filter(t=>t.isCustom);localStorage.setItem(ne(),JSON.stringify(e))},Oe=()=>{h.value.length>0?localStorage.setItem(q(),JSON.stringify(h.value)):localStorage.removeItem(q())},Ae=()=>{if(!O.value.trim())return;const e=A.value==="🚨 非常重要",t={id:`custom_${Date.now()}`,name:O.value.trim(),checked:!1,isMust:e,category:A.value,isCustom:!0};i.push(t),ie(),O.value="",Z.value=!1,e?Y.value=!0:L.value[A.value]=!0},oe=e=>{const t=i.findIndex(a=>a.id===e);if(t>-1){const a=i[t];i.splice(t,1),a.isCustom?ie():(h.value.push(e),Oe()),C()}},je=()=>{const e=[],t=localStorage.getItem(q());if(t)try{h.value=JSON.parse(t)}catch(n){console.error("Failed to parse deleted items",n),h.value=[]}else h.value=[];T.must.forEach(n=>{h.value.includes(n.id)||e.push({...n,isMust:!0,category:"🚨 絕對不能忘記"})}),T.categories.forEach(n=>{n.items.forEach(o=>{"gender"in o&&o.gender!==m.value||"country"in o&&o.country!==c.value||h.value.includes(o.id)||e.push({...o,isMust:!1,category:n.name})})});const a=localStorage.getItem(ne());if(a)try{JSON.parse(a).forEach(o=>{e.push(o)})}catch(n){console.error("Failed to parse custom items",n)}const s=localStorage.getItem(_());if(s)try{const n=JSON.parse(s);e.forEach(o=>{n.includes(o.id)&&(o.checked=!0)})}catch(n){console.error("Failed to parse saved items",n)}i.splice(0,i.length,...e)},Pe=(e,t,a)=>{if(!g.value&&v.value===a){if(t.stopPropagation(),Q.value){oe(e.id);return}if(e.checked=!e.checked,R.value===M.value&&M.value>0)for(let s=0;s<5;s++)setTimeout(()=>{I(window.innerWidth/2+(Math.random()-.5)*200,window.innerHeight/2+(Math.random()-.5)*200,"#10b981")},s*100);C()}},Te=()=>{i.forEach(e=>e.checked=!0),C()},Be=()=>{E.value=!0},We=()=>{localStorage.removeItem(_()),i.forEach(e=>e.checked=!1),E.value=!1,I(window.innerWidth/2,window.innerHeight/2,"#ef4444")},$e=()=>{E.value=!1},_e=()=>{for(let e=0;e<8;e++)setTimeout(()=>{I(window.innerWidth/2+(Math.random()-.5)*400,window.innerHeight/2+(Math.random()-.5)*400,e%2===0?"#10b981":"#6366f1")},e*150)},C=()=>{if(c.value&&m.value&&p.value===3){const e=i.filter(t=>t.checked).map(t=>t.id);e.length>0?localStorage.setItem(_(),JSON.stringify(e)):localStorage.removeItem(_())}},He=()=>{p.value=1,c.value="",m.value=""},H=l(!1),re=e=>{e.target.closest(".left-menu-container")||(H.value=!1,D.value=!1)},G=l(localStorage.getItem("weatherCity")||"Taipei"),ce=l(null),J=l(!1),V=[{id:"Tokyo",name:"東京",lat:35.6895,lon:139.6917},{id:"Seoul",name:"首爾",lat:37.5665,lon:126.978},{id:"Bangkok",name:"曼谷",lat:13.7563,lon:100.5018},{id:"Paris",name:"巴黎",lat:48.8566,lon:2.3522},{id:"London",name:"倫敦",lat:51.5074,lon:-.1278},{id:"New York",name:"紐約",lat:40.7128,lon:-74.006},{id:"Taipei",name:"台北",lat:25.033,lon:121.5654}],de=async()=>{const e=V.find(t=>t.id===G.value)||V[6];J.value=!0;try{const a=await(await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${e.lat}&longitude=${e.lon}&current_weather=true`)).json();ce.value=a.current_weather}catch(t){console.error("天氣載入失敗:",t)}finally{J.value=!1}},Xe=e=>{const t=e.target;G.value=t.value,localStorage.setItem("weatherCity",t.value),de()},Ye=e=>e===0?"☀️":e===1||e===2||e===3?"⛅":e>=45&&e<=48?"🌫️":e>=51&&e<=67?"🌧️":e>=71&&e<=77?"❄️":e>=80&&e<=82?"🌦️":e>=85&&e<=86?"🌨️":e>=95?"⛈️":"☁️",ze=async()=>{try{const e=await fetch(`/Per_OutTaiwan/announcements.json?t=${Date.now()}`);if(!e.ok)throw new Error("Fetch failed");const t=await e.json();t&&(P.value={countries:t.countries||{},global:t.global||{show:!1,message:""}})}catch(e){console.error("無法載入公告資訊:",e)}};S(K,e=>{e&&(Y.value=!1)});const X=()=>{const e=document.documentElement,t=document.body;e.classList.add("lock-all-scroll"),t.classList.add("lock-all-scroll")};S(p,X);const ue=()=>{D.value=!1,H.value=!1,z.value=!1};return{currentStep:p,selectedCountry:c,selectedGender:m,searchQuery:x,selectedCategoryFilter:U,expandedCategories:L,categories:u,countries:ee,mustItems:be,mustItemsExpanded:Y,filteredCategories:u,carouselContainer:fe,activeCategoryIndex:v,carouselOffset:f,isDragging:r,onMouseDown:ye,onTouchStart:Ce,onMouseLeave:Me,onMouseUp:k,getCategoryStyle:Ie,rotateTo:W,totalCount:M,packedCount:R,progressPercent:Le,announcementConfig:P,currentCountryAnnouncement:we,isHeaderExpanded:K,isLeftMenuOpen:D,isSearchPanelOpen:z,isDeleteMode:Q,peekingActive:he,showResetModal:E,showAddItemModal:Z,newItemName:O,newItemCategory:A,defaultItems:T,addCustomItem:Ae,removeItem:oe,isWeatherMenuOpen:H,selectedWeatherCity:G,weatherData:ce,isWeatherLoading:J,weatherCities:V,selectCountry:De,selectGender:Ee,toggleCategory:Se,toggleItem:Pe,markAllPacked:Te,resetList:Be,celebrateMore:_e,confirmReset:We,cancelReset:$e,prevCategory:ke,nextCategory:pe,selectWeatherCity:Xe,getWeatherIcon:Ye}},template:`
  ...
  `}),me=Ge(et);me.use(Je,{theme:{preset:Ve,options:{darkModeSelector:".dark"}}});me.mount("#app");
