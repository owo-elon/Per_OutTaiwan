import{R as M,V as y,S as w,P as b,W as C,a as k,C as O,b as D,D as I,c as T,M as x,g as u,d as P,e as U,i as E,f as S,L,r as m,o as B,w as z,h as A,j as F}from"./index-BJwqhLFL.js";class X{constructor(e,t,s,i,o){this.cards=[],this.radius=4,this.offset=0,this.targetOffset=0,this.velocity=0,this.isDragging=!1,this.lastMouseX=0,this.lastMouseY=0,this.totalMoved=0,this.raycaster=new M,this.mouse=new y,this.isDark=!1,this.lastActiveIndex=-1,this.container=e,this.items=t,this.isDark=s,this.onSelect=i,this.onActiveChange=o,this.boundOnMouseMove=this.onMouseMove.bind(this),this.boundOnMouseUp=this.onMouseUp.bind(this),this.boundOnTouchMove=this.onTouchMove.bind(this),this.boundOnResize=this.onResize.bind(this),this.scene=new w,this.camera=new b(45,e.clientWidth/e.clientHeight,.1,1e3),this.camera.position.z=10,this.renderer=new C({antialias:!0,alpha:!0}),this.renderer.setSize(e.clientWidth,e.clientHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.appendChild(this.renderer.domElement),this.initCards(),this.initEvents(),this.animate()}initCards(){const e=new k(1.92,2.88),t=`
      varying vec2 vUv;
      varying float vDist;
      void main() {
        vUv = uv;
  ...
  `}),p=P(R);p.use(U,{theme:{preset:E,options:{darkModeSelector:".dark"}}});p.mount("#app");
